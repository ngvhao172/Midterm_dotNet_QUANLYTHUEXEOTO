...
namespace dotNet_GK_QUANLYTHUEXEOTO.Model.Data
{
    public class BookingCarDbContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=LAPTOP-6AR4KNHR\SQLEXPRESS;Database=QLTHUEXEOTO;Trusted_Connection=True;TrustServerCertificate=True; MultipleActiveResultSets=true");
        }
